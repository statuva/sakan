...
class FirebaseCareActionRepository
    implements CareActionRepository {
  ...
  void _validateAction(
    ...
    if (action.familyId.trim().isEmpty) {
      throw ArgumentError(
        'Reminder family ID cannot be empty.',
      );
    }

    if (action.assignedMemberId
        .trim()
        .isEmpty) {
      throw ArgumentError(
